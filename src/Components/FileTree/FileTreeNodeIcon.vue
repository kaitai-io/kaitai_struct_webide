...
<template>
  <div v-if="type === EMPTY_FOLDER" class="icon">
  ...
  <div v-else-if="type === CLOSED_FOLDER" class="icon">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
  ...
  <div v-else-if="type === OPEN_FOLDER" class="icon">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
      <path fill-rule="evenodd"
  ...
  <div v-else-if="type === BINARY_FILE" class="icon">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
      <path
  ...
  <div v-else-if="type === KSY_FILE" class="icon">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
      <path fill-rule="evenodd"
