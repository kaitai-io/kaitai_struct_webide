var practiceDiff: AceAjax.Editor;

function practiceExportedChanged(exportedRoot: IExportedValue) {
    function exportedToJson(exported: IExportedValue) {
        var padLen = 2;
        ...
        function getLenComment(obj: IExportedValue) {
        ...
        function toJson(obj: IExportedValue, pad = 0) {
