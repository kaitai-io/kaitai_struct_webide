...
Parser = (function() {
  ...
  function Parser(offset, saveMeta) {
      ...
      if (values = this.PATTERN_SEQUENCE_ITEM.exec(this.currentLine)) {
        ...
        if (!(values.value != null) || '' === Utils.trim(values.value, ' ') || Utils.ltrim(values.value, ' ').indexOf('#') === 0) {
          if (this.currentLineNb < this.lines.length - 1 && !this.isNextLineUnIndentedCollection()) {
            ...
            parser = new Parser(c, this.saveMeta);
        ...
        if (data == null) {
          data = { };
          if(this.saveMeta)
            data.$meta = { lineIdx: this.getRealCurrentLineNb(), fields: {} };
        }
        ...
        if (mergeNode) {
          ...
          if (allowOverwrite || data[key] === void 0) {
            if (this.saveMeta) {
              data.$meta.fields[key] = data.$meta.fields[key] || {};
              data.$meta.fields[key].$line = this.getRealCurrentLineNb();
            }
            data[key] = val;
          }
        }
...
Yaml = (function() {
  ...
  Yaml.parse = function(input, exceptionOnInvalidType, objectDecoder, saveMeta) {
    if (exceptionOnInvalidType == null) {
      exceptionOnInvalidType = false;
    }
    if (objectDecoder == null) {
    ...
    return new Parser(0, saveMeta).parse(input, exceptionOnInvalidType, objectDecoder);
  };
