...
define(["require", "exports", "./components/ConverterPanel"], function (require, exports, ConverterPanel_1) {
    "use strict";
    ...
    $(() => {
        ...
        ui.hexViewer.onSelectionChanged = () => {
            ...
            new ConverterPanel_1.default(ui.converterPanel).refresh(dataProvider, start);
        };
        refreshSelectionInput();
